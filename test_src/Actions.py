...
class Actions:
    ...
    def execute_select(self, game_state, player_choice: int):
        ...
        available_characters = game.get_active_characters_from_game_state(state)
        ...
        del available_characters[chosen_character]
    ...
    # TODO: check here if character correctly updated in game_state
    # TODO: do deepcopy in agent not here
    def execute_move(self, game_state, player_choice):
        ...
        if self.character.color == "brown" and self.character.power_activated:
